    ...
    <section className={`relative w-full h-screen mx-auto`}>
      <div className="flex">
        ...
        >
          ...
          <div className="head2">
            <h1 className={`${styles.heroHeadText} text-white`}>
              Hii there, I'm <p className='name text-[#915EFF]'>Divyansh Gupta</p>
            </h1>
            <h3>
            ...
            <div className="absolute link1">
              <a
                href="https://github.com/DIVYANSH-675" target="_blank">
                <AiOutlineGithub />
              </a>
              <a
                href="https://www.linkedin.com/in/divyansh-gupta-b4396a207/" target="_blank">
                <ImLinkedin />
              </a>
              <a
                href="https://www.instagram.com/___divyansh__gupta___/" target="_blank">
                <AiOutlineInstagram />
              </a>
              <a
                href="https://codeforces.com/profile/divyansh_8" target="_blank">
                <BiLinkAlt />
              </a>
        ...
        <div className="imgcontainer1 absolute violet-gradient">
          <img src={profilePhoto} alt="" className="object-contain" />
        </div>
      </div>
